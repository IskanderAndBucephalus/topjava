...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.GET_BETWEEN, query = "SELECT m FROM Meal m WHERE m.user.id=:userId and m.dateTime >=:startRange " +
                "and m.dateTime <=:endRange ORDER BY m.dateTime DESC"),
